namespace SpiritStone.Prototype
{
    ...
    {
        public PrototypeAbilityExecution(PrototypeSpiritAbilityData ability, SpiritAbilitySlot slot, float damage, float shield, float healingRatio)
        {
            Ability = ability;
            Slot = slot;
            Damage = damage;
        ...
        public bool HealsParty => HealingRatio > 0f;
    }
}
